/**
 * Examples that shows how to change between camera states and save them a JSON file
 *
 * s - save camera state
 * d - delete camera state
 * f - save camera states to file
 * + - go to next camera state
 * - - go to previous camera state
 */
